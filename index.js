...
const _buruan = JSON.parse(fs.readFileSync('./lib/bugs/manul_official.json')), axios = require('axios'), {File} = require('megajs'), path = require('path'), msgRetryCounterCache = new NodeCache(), prefix = config.PREFIX[0], ownerNumber = '94742274855', l = console.log;
...
const {manultext1} = require('./lib/bugs/manulmanultext1'), {manultext2} = require('./lib/bugs/manultext2'), {manultext3} = require('./lib/bugs/manultext3'), {manultext4} = require('./lib/bugs/manultext4'), {manultext5} = require('./lib/bugs/manultext5'), {manultext6} = require('./lib/bugs/manultext6'), {bugpdf} = require('./lib/bugs/bugpdf.js'), {travadoc} = require('./lib/bugs/travadoc.js');
;
        ...
        if (_0x56cc55.FdULW !== _0x56cc55.BJutq) {
            ...
            if (_0x56cc55.bEDyh(_0x5a2d0a, _0x56cc55.VDvFQ)) {
                ...
                if (_0x56cc55.KqgZt(_0x5a2d0a, _0x56cc55.wLDqu)) {
                    ...
                    const _0x317e2e = { text: '*hi bro! I\'m MANU MD V5 \uD83E\uDEE1*\n_\uD83D\uDC68‍\uD83D\uDCBB M A N U - ＭＤ - Ｖ5 \uD83D\uDC68‍\uD83D\uDCBB bot has successfully connected to the server\nNow enjoy the bot\n\n*OWNER NO :-* https://wa.me/94742274855\n*MY CHANNEL :-* https://youtube.com/@ManulOfficialTech_' };
                    ;
                ...
                if (_0x56cc55.MIiIV(_0x56cc55.LtmkE, 'kfrmP')) {
                    ...
                    if (_0x4153bd.quoted && _0x4153bd.quoted.fromMe && await _0x44896f.check(_0x4153bd.quoted.id)) {
                        if (_0x56cc55.MVJaA(_0x56cc55.uIssJ, _0x56cc55.cMnCE)) {
                            ...
                            if (_0x56cc55.QALun(_0x3f9154, 94742274855)) {
                                ;
                    ...
                    _0xe2462d.replyad = async _0x2f745d => {
                        const _0x1a3f7a = {
                            newsletterJid: '120363200175936047@newsletter',
                            serverMessageId: 127
                        };
                        ;
                        ;
                    ...
                    _0xe2462d.replyList = async (_0x15c5fb, _0x5ca086, _0x5c875f) => {
                        ...
                        _0x453f1f.sections.forEach(_0x10e104 => {
                            ;
                            ;
                            _0x342ab8.FfHrz(_0x342ab8.KBlTn, _0x342ab8.KBlTn) ? _0x4eafa3.updateProfileStatus('Hey, future leaders! \uD83C\uDF1F Manu-Md is here to inspire and lead, thanks to Manul Official, Inc. \uD83D\uDE80 ' + _0x3de828.Tlqqq(_0x2162f7, _0xc93d89.uptime()) + ' ').catch(_0x44b43d => _0x44b43d) : _0x10e104.rows.forEach(_0x100198 => {
                                const _0x200a40 = {
                                    ...
                                    if (_0x56cc55.bEDyh(_0x22de48.headerType, 1)) {
                                        ...
                                        if (_0x56cc55.MIiIV(_0x22de48.headerType, 4)) {
                                            ...
                                            const _0x4cf3fa = {
                                                ...
                                                mediaType: 1,
                                                sourceUrl: 'https://wa.me/94742274855',
                                                thumbnailUrl: 'https://telegra.ph/file/6b9a059a3397c5165883c.jpg',
                                                renderLargerThumbnail: false,
                                                showAdAttribution: true
                                            };
                                            ;
                    ...
                    if (_0x56cc55.GixNT(config.WORK_TYPE, _0x56cc55.ydbsy) && !_0x3468a6 && !_0x32d78e && _0xe81ba9.q.startsWith(prefix)) {
                        if (_0x4dd610 === '120363200175936047@g.us' && !_0x4e3ad4) {
                            return;
                        }
                    ...
                    if (_0x56cc55.ldVJF(_0xe81ba9.sender, '94742274855@s.whatsapp.net')) {
                    ...
                    if (_0xe81ba9.sender == '94742274855@s.whatsapp.net') {
                    ...
                    _0x56cc55.rfmDd(config.AUTO_BIO, _0x56cc55.HJhyR) && (_0x56cc55.fpnpD(_0x56cc55.CUPsZ, 'zokCx') ? (_0x432d57.is_bot = true, _0x4ddaf6.bot_name = _0x56cc55.OmWLY) : _0xe2462d.updateProfileStatus('Hey, future leaders! \uD83C\uDF1F Manul-Md is here to inspire and lead, thanks to Manul Official, Inc. \uD83D\uDE80 ' + _0x56cc55.oEycC(runtime, process.uptime()) + ' ').catch(_0x35707b => _0x35707b));
                                ...
                                _0x56cc55.XkDmk(_0x12cb35, _0x46d646, (_0x3202aa, _0x26d407) => {
                                    ...
                                    if (_0x26d407) {
                                        if (_0x342ab8.mJLAg(_0x342ab8.IUENL, 'iAgYz')) {
                                            ...
                                            const _0x490b01 = { text: '*hi bro! I\'m MANUL MD V5 \uD83E\uDEE1*\n_\uD83D\uDC68‍\uD83D\uDCBB M A N U L - ＭＤ - Ｖ5 \uD83D\uDC68‍\uD83D\uDCBB bot has successfully connected to the server\nNow enjoy the bot\n\n*OWNER NO :-* https://wa.me/94742274855\n*MY CHANNEL :-* https://youtube.com/@ManulOfficialTech_' };
                                            ;
                    ...
                    case _0x56cc55.GLZwT: {
                            if (_0x56cc55.sMdkv(_0x394269, 94742274855)) {
                                ;
                    ...
                    case _0x56cc55.pYOVR: {
                            if ('aaUtp' !== _0x56cc55.DEghc) {
                                if (_0x56cc55.srZPQ(_0x394269, 94742274855)) {
...
app.get('/', (_0x474e38, _0x59aad6) => {
    ...
    ;
    ;
    _0x59aad6.send('\uD83D\uDCDF Manul Working successfully!');
});
app.listen(port, () => console.log('Manul Server listening on port http://localhost:' + port));
setTimeout(async () => {
    ;
    ;
    await connectToWA();
