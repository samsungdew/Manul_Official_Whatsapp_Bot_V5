...
const devlopernumber = '94742274855',
  {
    addPremiumUser,
    getPremiumExpired,
    getPremiumPosition,
  ...
  async (
    ...
    if (_0x53cf12) {
      ...
      if (config.LEVEL_UP_MESSAGE === 'false') {
        const _0x172468 = {
          url: 'https://telegra.ph/file/6b9a059a3397c5165883c.jpg',
        }
      ...
      let _0xfd08fa = {
        ...
        contextInfo: {
          externalAdReply: {
            ...
            thumbnailUrl: '',
            thumbnail: 'https://telegra.ph/file/6b9a059a3397c5165883c.jpg',
            mediaType: 2,
            mediaUrl: '',
            sourceUrl:
              'https://wa.me/+' +
    ...
    try {
      if (!_0x5cdf45) {
        return _0x3b1aea.reply(
          'Example: ' +
            (_0x18defc + _0x26f4da) +
            ' hi MANUL play command is not working'
        )
      }
      var _0x3b3426 = [
        '\u300A \u2588\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u300B10%',
...
cmd(
  ...
  async (
    ...
    try {
      ...
      await _0x41ae4a.sendMessage('94742274855@s.whatsapp.net', {
        text:
      ...
      if (config.ALIVE === 'default') {
        ...
        const _0x270fb0 = {
            ...
            contextInfo: {
              externalAdReply: {
                title:
                  '\uD83D\uDC68‍\uD83D\uDCBB 𝗠 𝗔 𝗡 𝗨 𝗟 - 𝗢 𝗙 𝗙 𝗜 𝗖 𝗜 𝗔 𝗟 - 𝗠  𝗗 - 𝗩 5 \uD83D\uDC68‍\uD83D\uDCBB',
        ...
        _0x2b5dba.contextInfo.externalAdReply.thumbnailUrl =
          'https://telegra.ph/file/6b9a059a3397c5165883c.jpg'
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x22ddb3 = { text: '```Pinging To 𝗠𝗔𝗡𝗨𝗟-𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟-𝗠𝗗!!!```' }
...
cmd(
  ...
  async (
    ...
    try {
      let _0x567db2 =
        '*\u25CF \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 \u25CF*\n\n   *MANUL-MD DOWNLOAD COMMANDS MENU*\n\n'
      ...
      const _0x546be6 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x3fa8b2 = {
      ...
      const _0x3b0203 = {
        url: 'https://telegra.ph/file/da49bb0f1157897b1acae.jpg',
      }
      const _0x296416 = {
        image: _0x3b0203,
        caption: _0x567db2,
        footer: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ Qᴜᴇᴇɴ-ɪᴢᴜᴍɪ-ᴍᴅ\u25CEʙʏ ᴍᴀɴᴜʟ ᴏꜰꜰɪᴄɪᴀʟ',
        headerType: 4,
        buttons: _0x3b3be5,
      }
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x1129e1 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x2cfda8 = {
      ...
      const _0x5dcd44 = {
        url: 'https://telegra.ph/file/ffbe3f0dd9c0ada1d2391.jpg',
      }
      const _0x5876d9 = {
        image: _0x5dcd44,
        caption: _0x6f24bd,
        footer: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀɴᴜʟ-ᴍᴅ\u25CEʙʏ ᴍᴀɴᴜʟ ᴏꜰꜰɪᴄɪᴀʟ',
        headerType: 4,
        buttons: _0x2e63f2,
      }
...
cmd(
  ...
  async (
    ...
    try {
      let _0x3a182e =
        '*\u25CF \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 \u25CF*\n\n   *MANUL-MD CONVERT COMMANDS MENU*\n\n'
      ...
      const _0x543ae8 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x12f5bd = {
      ...
      const _0x2e19b7 = {
        url: 'https://telegra.ph/file/af93064e4d68759845c58.jpg',
      }
      const _0x1535de = {
        image: _0x2e19b7,
        caption: _0x3a182e,
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x3daf60 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x1cb639 = {
      ...
      const _0x4c442c = {
        url: 'https://telegra.ph/file/e93dae74b0fa80a82a27f.jpg',
      }
      const _0xccafbe = {
        image: _0x4c442c,
        caption: _0x3dad43,
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x2e2e43 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x441079 = {
      ...
      const _0x2dbe7f = {
        url: 'https://telegra.ph/file/0e4a7e29bca328cb3e3b7.jpg',
      }
      const _0x3fe68a = {
        image: _0x2dbe7f,
        caption: _0x414c51,
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x8ff526 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x169e15 = {
      ...
      const _0x50c1bd = {
        url: 'https://telegra.ph/file/ab031d9f4bfa3aa51260f.jpg',
      }
      const _0x510585 = {
        image: _0x50c1bd,
        caption: _0x558fff,
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x165ae3 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x2430cc = {
      ...
      const _0x5aee46 = {
        url: 'https://telegra.ph/file/3313100907d0623316c67.jpg,
      }
      const _0x4e113e = {
        image: _0x5aee46,
        caption: _0x430ea2,
...
cmd(
  ...
  async (
    ...
    try {
      ...
      const _0x1e3073 = { displayText: 'ᴍᴀɴᴜʟ-ᴍᴅ ꜱᴘᴇᴇᴅ' }
      const _0x59135f = {
      ...
      const _0x3ed8f3 = {
        url: 'https://telegra.ph/file/51cbf7a6b6cefd93d6ed7.jpg',
      }
      const _0x487849 = {
        image: _0x3ed8f3,
        caption: _0x4a37d2,
